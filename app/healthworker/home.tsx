...
export default function DoctorDashboard() {
  ...
  const comments = [
    { id: '1', name: 'Moses Aubrey', text: 'Love the experience, great job guys', date: '20/04/24' },
    { id: '2', name: 'Keith K. John', text: 'Love the experience, great job guys', date: '29/03/24' },
  ];
