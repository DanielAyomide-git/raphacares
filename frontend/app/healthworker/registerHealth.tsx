...
export default function RegisterPage() {
  ...
  const handleRegister = async () => {
    ...
    const userData = {
      username: phoneNumber, // Or use another input for username
      email: email,
      password: password,
      category: category,
    };
    ...
    try {
      ...
      if (response.data.message === 'User registered successfully') {
        ...
        router.push('/healthworker/healthWorker');  // Redirect to login page
      } else {
  ...
  return (
    <Animated.View style={[styles.container, { transform: [{ translateX: slideAnim }] }]}>
      ...
      <TouchableOpacity style={styles.loginContainer}>
        <Text onPress={() => router.push('/healthworker/healthWorker')} style={styles.loginText}>
